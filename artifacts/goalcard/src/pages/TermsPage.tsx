  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a1a", fontFamily: "'Poppins', sans-serif" }}>
      ...
      <main style={{ maxWidth: "700px", margin: "0 auto", padding: "48px 24px" }}>
        ...
        <p style={s}>Welcome to PerdictionCard ("the Service"), operated by PerdictionCard ("we", "us", "our"). By accessing or using perdictioncard.com, you agree to be bound by these Terms of Service.</p>

        <h2 style={h2}>1. Use of the Service</h2>
        <p style={s}>PerdictionCard provides a free online tool that lets you generate FIFA World Cup 2026 match prediction image cards. You may use the Service for personal, non-commercial purposes. You must not use the Service to generate, share, or distribute any content that is offensive, illegal, defamatory, or infringes on third-party rights.</p>
        ...
        <p style={s}>The prediction cards you generate are yours to share. The PerdictionCard branding, logo, design, and source code are owned by us and may not be reproduced or redistributed without permission. This service is not affiliated with, endorsed by, or sponsored by FIFA or any national football federation.</p>
        ...
        <p style={s}>To the fullest extent permitted by law, PerdictionCard shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service, even if we have been advised of the possibility of such damages.</p>
